...
This teacher--student experiment is therefore an uncertified ablation rather
than a second proposed method. The six-context net gain over nearest-start
shows that the student learns some constraint-relevant structure, but fast
boundary imitation neither certifies the induced option library nor transfers
the teacher's group and value guarantees. The explicit Green operator remains
our search-free proposal; the learned student does not replace its mathematical
certificate or the production audit.
