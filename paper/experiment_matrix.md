...
| Do multi-task rewards preserve graph compression? | fixed-`B` edge reward relabeling, terminal event kernels, goal-conditioned option-interface ablation | `experiments/run_edge_reward_kernel_multitask.py`, `experiments/output/edge_reward_kernel_multitask/` | implemented |
