...
| Can a learned forward pass replace boundary search and audit? | transition-graph GNN distillation, nearest-start baseline, scale/topology holdouts, production group/value audit, selective-routing calibration | `experiments/run_boundary_heatmap_gnn.py`, `experiments/output/boundary_heatmap_gnn_graphonly/`, `markdown/boundary_heatmap_teacher_student_report.md` | completed uncertified ablation: modest constrained gain over nearest-start, audit still required |
