...
5. Next: ask GPT/reviewer to attack the updated `submission_main_table` and decide whether the negative amortized-all-state result should be shown only as a failure-mode/limitation beside the fixed-`B` edge reward result.
