...
LEARNED_RECIPES: Dict[str, Dict[str, object]] = {
    ...
    "learned_exact_mdl": {
        ...
        "residual_threshold": 0.5,
        "residual_threshold_mode": "raw",
        "residual_split_policy": "exact_mdl",
        "compute_struct_distinct": True,
        "soft_kind": "combined",
        "soft_top_fraction": 0.15,
        "soft_threshold": 3.0,
        "soft_split_policy": "never",
        "struct_mdl_edge_cost_weight": 0.5,
        "exact_mdl_option_pair_bit_cost": 0.25,
    },
    "learned_exact_mdl_struct_only": {
        "candidate_kind": "articulation_only",
        "proposal_kind": "candidate",
        "candidate_top_fraction": 0.15,
        "residual_kind": "turn_articulation",
        ...
        "soft_split_policy": "never",
        "struct_mdl_edge_cost_weight": 0.5,
        "exact_mdl_option_pair_bit_cost": 0.0,
        "exact_mdl_policy_tv_bit_cost": 0.0,
        "exact_mdl_policy_region_bit_cost": 0.0,
        "exact_mdl_model_residual_bit_cost": 0.0,
    },
    ...
    "learned_rd_audit_cvar2": {
        ...
        "struct_mdl_edge_cost_weight": 0.5,
        "exact_mdl_option_pair_bit_cost": 0.25,
        "rd_struct_kind": "audit_distinct_cvar95",
        "rd_struct_budget": 2.0,
        "rd_batch_k": 4,
    },
    "learned_rd_joint_occ2_audit2": {
        ...
        "struct_mdl_edge_cost_weight": 0.5,
        "exact_mdl_option_pair_bit_cost": 0.25,
        "rd_struct_kind": "occupancy_distinct",
        "rd_struct_budget": 2.0,
        "rd_audit_kind": "audit_distinct_cvar95",
        "rd_audit_budget": 2.0,
        "rd_batch_k": 4,
    },
    "learned_rd_surrogate_joint_occ2_audit2": {
        ...
        "residual_threshold": 0.5,
        "residual_threshold_mode": "raw",
        "residual_split_policy": "rd_surrogate",
        "compute_struct_distinct": True,
        "soft_kind": "combined",
        "soft_top_fraction": 0.15,
        "soft_threshold": 3.0,
    ...
    "learned_exact_mdl_proposal_eigen12": {
        "candidate_kind": "articulation_only",
        "proposal_kind": "eigen_extrema_12",
        "candidate_top_fraction": 0.15,
        "residual_kind": "turn_articulation",
...
def learned_boundary(
    ...
    for row in trace:
        if row.get("stop_reason") == "continue" and row.get("split_candidate_state") is not None:
            states = row.get("split_candidate_states", [row["split_candidate_state"]])
            if isinstance(states, str):
                states = [row["split_candidate_state"]]
            for state in states:
