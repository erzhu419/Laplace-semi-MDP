...
def row_from_model(
    ...
    return {
        ...
        "start_value_full": float(model["start_value_full"]),
        "value_scale": float(model["value_scale"]),
        "normalized_start_gap": float(model["normalized_start_gap"]),
        "value_gap_max": float(model["value_gap_max"]),
        "normalized_value_gap_max": float(model["normalized_value_gap_max"]),
